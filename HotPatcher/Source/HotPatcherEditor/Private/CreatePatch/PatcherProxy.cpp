...
bool UPatcherProxy::DoExport()
{
	...
	UE_LOG(LogHotPatcher,Display,TEXT("Deserialize BaseVersion/Export New Version/Diff Patch time %ds"),ExportVersionUsedTime.GetTotalSeconds());
	...
	OnShowMsg.Broadcast(FString::Printf(TEXT("The Patch execution time of this task is %d seconds"),ExecutionTime.GetTotalSeconds()));
	return true;
}
